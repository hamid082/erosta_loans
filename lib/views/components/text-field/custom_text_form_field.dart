  ...
  Widget build(BuildContext context) {
    return widget.isUnderline
        ? TextFormField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: widget.isShowSuffixIcon
                  ? widget.isPassword
                      ? IconButton(icon: Icon(_obscureText ? Icons.visibility_off : Icons.visibility, color: MyColor.hintTextColor, size: 16), onPressed: _toggle)
                      : widget.isIcon
                          ? IconButton(
        ...
        : TextFormField(
            ...
            controller: widget.controller,
            focusNode: widget.focusNode,
            style: interRegularDefault.copyWith(color: MyColor.textColor, fontSize: Dimensions.fontLarge),
            textInputAction: widget.inputAction,
            keyboardType: widget.inputType,
            ...
            decoration: InputDecoration(
              ...
              hintStyle: interRegularDefault.copyWith(fontSize: Dimensions.fontDefault, color: MyColor.colorGrey),
              filled: true,
              prefixIcon: widget.isShowPrefixIcon
                  ? Padding(
                      padding: const EdgeInsets.only(left: Dimensions.paddingSize20, right: Dimensions.paddingSize10),
                      child: Icon(
