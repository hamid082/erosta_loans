...
import 'package:erosta_loans/views/components/shimmer/myloan_card_shimmer.dart';
import 'package:erosta_loans/views/screens/bottom_nav_screen/home/widget/all_loan_plans_title.dart';
import 'package:erosta_loans/views/screens/bottom_nav_screen/home/widget/kyc_warning_section.dart';
import 'package:erosta_loans/views/screens/bottom_nav_screen/home/widget/running_loan_bottom_shet.dart';
...
import 'package:erosta_loans/views/screens/bottom_nav_screen/loan/widget/running_loan_list_card.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            RadiusCardShape(
              ...
              widget: Column(
                children: [
                  controller.runningLoanList.isNotEmpty ? const TitleLabel(titleLabel: MyStrings.myRunningLoan) : const AllLoanPlanTitle(),
                  const SizedBox(height: Dimensions.space12),
                  controller.isLoading
                      ? const MyLoanCardShimmer()
                          ...
                          ? ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                return RunningLoanListCard(
                                  ...
                                  press: () {
                                    RunningLoanBottomSheet().bottomSheet(context, index);
                                  },
                                );
                              })
                          : GetBuilder<LoanPlanController>(builder: (loanPlanController) {
                              return loanPlanController.isLoading
                                  ...
                                  : loanPlanController.planList.isEmpty
                                      ? NoDataWidget(
                                          topMargin: MediaQuery.of(context).size.height / 20,
                                        )
                                      : ListView.separated(
                                          shrinkWrap: true,
                                          scrollDirection: Axis.vertical,
