...
import 'package:rapid_loan/data/controller/auth/two_factor_controller.dart';
import 'package:rapid_loan/data/repo/auth/two_factor_repo.dart';
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: PinCodeTextField(
                            ...
                            pinTheme: PinTheme(
                                shape: PinCodeFieldShape.box, borderWidth: 1, borderRadius: BorderRadius.circular(5), fieldHeight: 40, fieldWidth: 40, inactiveColor: MyColor.borderColor, inactiveFillColor: MyColor.containerBgColor, activeFillColor: MyColor.containerBgColor, activeColor: MyColor.primaryColor, selectedFillColor: MyColor.containerBgColor, selectedColor: MyColor.primaryColor),
