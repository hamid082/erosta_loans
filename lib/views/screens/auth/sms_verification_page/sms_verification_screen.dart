...
import 'package:erosta_loans/data/controller/auth/auth/sms_verification_controler.dart';
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: PinCodeTextField(
                              ...
                              pinTheme: PinTheme(
                                  shape: PinCodeFieldShape.box, borderWidth: 1, borderRadius: BorderRadius.circular(5), fieldHeight: 40, fieldWidth: 40, inactiveColor: MyColor.borderColor, inactiveFillColor: MyColor.transparentColor, activeFillColor: MyColor.transparentColor, activeColor: MyColor.primaryColor, selectedFillColor: MyColor.transparentColor, selectedColor: MyColor.primaryColor),
                            ...
                            children: [
                              ...
                              controller.resendLoading
                                  ...
                                  : GestureDetector(
                                      ...
                                      child: Text(MyStrings.resend.tr, style: interRegularDefault.copyWith(decoration: TextDecoration.underline, color: MyColor.primaryColor))),
                            ],
                          )
                        ],
                      ),
