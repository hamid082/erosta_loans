...
import 'package:erosta_loans/data/model/loan/loan_preview_response_model.dart';
...
// catagory plans
  ...
  void submitLoanPlan(String planId, int index) async {
    ...
    double minLimit = double.tryParse(selectcatagori?.plans![index].minimumAmount ?? '0') ?? 0;
    double maxLimit = double.tryParse(selectcatagori?.plans![index].maximumAmount ?? '0') ?? 0;
